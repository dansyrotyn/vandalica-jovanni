...
namespace Coherence.Log
{
    ...
    public class UnityLogger : Logger
    {
        ...
        public delegate void OnWarningLogEvent(object context, Warning warning, string message, params (string key, object value)[] args);
        public delegate void OnErrorLogEvent(object context, Error error, string message, params (string key, object value)[] args);
        ...
        public static OnWarningLogEvent OnLogWarningEventExt;
        public static OnErrorLogEvent OnLogErrorEventExt;

        private Object unityLogContext;

        public UnityLogger(Type source = null, List<ILogTarget> baseLogTargets = null, IEnumerable<ILogTarget> customLogTargets = null)
            : base(source, null, baseLogTargets, customLogTargets)
        {
        }
        ...
        {
            var newLogger = new UnityLogger(source, baseLogTargets, customLogTargets);
        ...
        public override void Warning(Warning id, params (string key, object value)[] args)
        {
            ...
            OnLogWarningEventExt?.Invoke(Context, id, log, args);
        }
        ...
        public override void Warning(Warning id, string msg, params (string key, object value)[] args)
        {
            ...
            OnLogWarningEventExt?.Invoke(Context, id, msg, args);
        }
        ...
        public override void Error(Error id, params (string key, object value)[] args)
        {
            ...
            OnLogErrorEventExt?.Invoke(Context, id, log, args);
        }
        ...
        public override void Error(Error id, string msg, params (string key, object value)[] args)
        {
            ...
            OnLogErrorEventExt?.Invoke(Context, id, msg, args);
        }
