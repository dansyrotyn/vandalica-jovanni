...
namespace Coherence.Log
{
    public enum Error
    {
        ...
        ReplicationManagerNetworkIncompatibleVersion,
        ...
        ToolkitBindingIsDirtyException,
        ...
        ToolkitEntitiesManagerUnknownChannel,
...
#pragma warning restore CS8524
            {
                ...
                Error.CoreConnectionError => "Connection error.",
                ...
                Error.EntityManagerUpdateInvalid => "Can not update entity, invalid update request",
                ...
                Error.ReplicationManagerNetworkIncompatibleVersion => "incompatible version",
                ...
                Error.ReplicationUnknownChannel => "cannot find the channel with the given ID",
                ...
                Error.RuntimeCloudGameServicesKVNotEnabled => "K/V store not enabled. Visit the Online Dashboard to enable it.",
                ...
                Error.ToolkitBindingIsDirtyException => "", // Uses ErrorMsg.
                ...
                Error.ToolkitEntitiesManagerUnknownChannel => "", // Uses ErrorMsg
                ...
                Error.ToolkitRelayFlushException => "", // Uses ErrorMsg
                ...
                Error.ToolkitPlayerAccountError => "", // Uses ErrorMsg
